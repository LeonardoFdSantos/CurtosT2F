...
fprintf('terminado T2F Calculo Simulação! \n');

%% Comparação entre Trifásico e T2F sem Compensação
valores_resultados_simulacao_meio_linha_sem_comp(1, :) = string({'n' 'tipoCurto' 'Raf' 'Rbf' 'Rcf' 'RaTrif' 'RbTrif' 'RcTrif' 'cequa' 'ccc' 'cct1' 'cct2' 'VA_T2F' 'VB_T2F' 'VC_T2F' 'VA_TRIF' 'VB_TRIF' 'VC_TRIF' 'IA_T2F' 'IB_T2F' 'IC_T2F' 'IA_TRIF' 'IB_TRIF' 'IC_TRIF'});
valores_resultados_simulacao_fim_linha_sem_comp(1, :) = string({'tipoCurto' 'Raf' 'Rbf' 'Rcf' 'RaTrif' 'RbTrif' 'RcTrif' 'cequa' 'ccc' 'cct1' 'cct2' 'VA_T2F' 'VB_T2F' 'VC_T2F' 'VA_TRIF' 'VB_TRIF' 'VC_TRIF' 'IA_T2F' 'IB_T2F' 'IC_T2F' 'IA_TRIF' 'IB_TRIF' 'IC_TRIF'});

c = 1;
e = 1;

load('trif2awg.mat');
% load('trif2awg_teste.mat');
...
%   sim('.\SimCurtoCircuitoFimLinhaT2FComp.slx')
    ...
    valores_resultados_simulacao_fim_linha_sem_comp(b+1, :) = [tipoCurto Raf Rbf Rcf RaTrif RbTrif RcTrif cequa ccc cct cct Tensao_T2F_Ensaio Tensao_Trifasica_Ensaio Corrente_T2F_Ensaio Corrente_Trifasica_Ensaio];
...
%         sim('.\SimCurtoCircuitoMeioLinhaT2FComp.slx') 
        ...
        valores_resultados_simulacao_meio_linha_sem_comp(c+1, :) = [m1 tipoCurto Raf Rbf Rcf RaTrif RbTrif RcTrif cequa ccc cct cct Tensao_T2F_Ensaio Tensao_Trifasica_Ensaio Corrente_T2F_Ensaio Corrente_Trifasica_Ensaio];
...
%% Comparação entre Trifásico e T2F com compensação
valores_resultados_simulacao_meio_linha_com_comp(1, :) = string({'n' 'tipoCurto' 'Raf' 'Rbf' 'Rcf' 'RaTrif' 'RbTrif' 'RcTrif' 'cequa' 'ccc' 'cct1' 'cct2' 'VA_T2F' 'VB_T2F' 'VC_T2F' 'VA_TRIF' 'VB_TRIF' 'VC_TRIF' 'IA_T2F' 'IB_T2F' 'IC_T2F' 'IA_TRIF' 'IB_TRIF' 'IC_TRIF'});
valores_resultados_simulacao_fim_linha_com_comp(1, :) = string({'tipoCurto' 'Raf' 'Rbf' 'Rcf' 'RaTrif' 'RbTrif' 'RcTrif' 'cequa' 'ccc' 'cct1' 'cct2' 'VA_T2F' 'VB_T2F' 'VC_T2F' 'VA_TRIF' 'VB_TRIF' 'VC_TRIF' 'IA_T2F' 'IB_T2F' 'IC_T2F' 'IA_TRIF' 'IB_TRIF' 'IC_TRIF'});
...
for b = [1:1:5]
    ...
    valores_resultados_simulacao_fim_linha_com_comp(b+1, :) = [tipoCurto Raf Rbf Rcf RaTrif RbTrif RcTrif cequa ccc cct cct Tensao_T2F_Ensaio Tensao_Trifasica_Ensaio Corrente_T2F_Ensaio Corrente_Trifasica_Ensaio];
...
for n = Parametros_testes
    ...
    for b = [1:1:5]
        ...
        valores_resultados_simulacao_meio_linha_com_comp(c+1, :) = [m1 tipoCurto Raf Rbf Rcf RaTrif RbTrif RcTrif cequa ccc cct cct Tensao_T2F_Ensaio Tensao_Trifasica_Ensaio Corrente_T2F_Ensaio Corrente_Trifasica_Ensaio];
