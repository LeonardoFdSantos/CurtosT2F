...
valores_resultados_simulacao_fim_linha_com_comp(1, :) = string({'n' 'tipoCurto' 'Raf1' 'Rbf1' 'Rcf1' 'Raf2' 'Rbf2' 'Rcf2' 'IA_T2F' 'IB_T2F' 'IC_T2F'});
valores_resultados_simulacao_meio_linha_com_comp_1(1, :) = string({'n' 'm1' 'tipoCurto' 'Raf1' 'Rbf1' 'Rcf1' 'Raf2' 'Rbf2' 'Rcf2' 'IA_T2F' 'IB_T2F' 'IC_T2F'});
valores_resultados_simulacao_meio_linha_com_comp_2(1, :) = string({'n' 'm2' 'tipoCurto' 'Raf1' 'Rbf1' 'Rcf1' 'Raf2' 'Rbf2' 'Rcf2' 'IA_T2F' 'IB_T2F' 'IC_T2F'});
...
for b = [1:1:10]
    ...
    valores_resultados_simulacao_fim_linha_com_comp(c+1, :) = [b tipoCurto Raf1 Rbf1 Rcf1 Raf2 Rbf2 Rcf2 CorrenteSistemaT2F_lista];
    c = c + 1;
end
...
for m2 = Parametros_testes
    for b = [1:1:10]
        ...
        CorrenteSistemaT2F_lista = abs(CorrenteSistemaT2F)/sqrt(2);
        valores_resultados_simulacao_meio_linha_com_comp_2(c+1, :) = [c m1 tipoCurto Raf1 Rbf1 Rcf1 Raf2 Rbf2 Rcf2 CorrenteSistemaT2F_lista];
        c = c + 1;
    end
end
