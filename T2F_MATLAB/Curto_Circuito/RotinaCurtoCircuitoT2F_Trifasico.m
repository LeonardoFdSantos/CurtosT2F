...
writematrix(valores_resultados_simulacao_meio_linha_T2F, 'valores_resultados_simulacao_meio_linha_T2F.csv');
writematrix(valores_resultados_simulacao_fim_linha_T2F, 'valores_resultados_simulacao_fim_linha_T2F.csv');

writematrix(valores_resultados_simulacao_fim_linha_Trifasico, 'valores_resultados_simulacao_fim_linha_Trifasico.csv');
writematrix(valores_resultados_simulacao_meio_linha_Trifasico, 'valores_resultados_simulacao_meio_linha_Trifasico.csv');
